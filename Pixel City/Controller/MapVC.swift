...
class MapVC: UIViewController, UIGestureRecognizerDelegate {
    ...
    func addProgressLabel() {
        progLabel = UILabel()
        progLabel?.frame = CGRect(x: (screenSize.width / 2) - 120, y: 175, width: 240, height: 40)
        progLabel?.font = UIFont(name: "Avenir Next", size: 18)
        progLabel?.textColor = #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1)
        progLabel?.textAlignment = .center
        progLabel?.text = "12/40 photos Loaded"
        collectionView?.addSubview(progLabel!)
    }
